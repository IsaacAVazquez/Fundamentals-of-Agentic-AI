...
A throwaway review account exists in the shared Neon database, designreview@example.com, created on 2026-09-08 for the redesign inspection. It held five entries across all three priorities during the walkthrough and has four since the walkthrough deleted the low priority one, and it is fine to reuse for screenshots. The README's two-account privacy check, re-run on 2026-09-13, uses it as User A and privacy-b-20260913@example.com as User B.
